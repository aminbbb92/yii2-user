...
use aminbbb92\user\filters\AccessRule;
use aminbbb92\user\Finder;
use aminbbb92\user\models\Profile;
use aminbbb92\user\models\User;
use aminbbb92\user\models\UserSearch;
use aminbbb92\user\helpers\Password;
...
class AdminController extends Controller
{
    ...
    /**
     * If "aminbbb92/yii2-rbac" extension is installed, this page displays form
    ...
    {
        if (!isset(\Yii::$app->extensions['aminbbb92/yii2-rbac'])) {
