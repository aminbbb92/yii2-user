...
```php
'facebook' => [
    'class'        => 'aminbbb92\user\clients\Facebook',
    'clientId'     => 'APP_ID',
...
```php
'twitter' => [
    'class'          => 'aminbbb92\user\clients\Twitter',
...
```php
'google' => [
    'class'        => 'aminbbb92\user\clients\Google',
    'clientId'     => 'CLIENT_ID',
...
```php
'github' => [
    'class'        => 'aminbbb92\user\clients\GitHub',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
],
```
...
```php
'vkontakte' => [
    'class'        => 'aminbbb92\user\clients\VKontakte',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
]
```
...
```php
'yandex' => [
    'class'        => 'aminbbb92\user\clients\Yandex',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
```php
'linkedin' => [
    'class'        => 'aminbbb92\user\clients\LinkedIn',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
use aminbbb92\user\controllers\SecurityController; 
