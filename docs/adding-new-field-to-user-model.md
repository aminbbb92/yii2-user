...
```php
class User extends \aminbbb92\user\models\User
{
...
You should override view file `@aminbbb92/user/views/admin/_user.php` as described in [special guide](overriding-views.md)
...
```php
class RegistrationForm extends \aminbbb92\user\models\RegistrationForm
{
    /**
     * @var string
     */
