...
```php
'user' => [
    'class' => \aminbbb92\user\Module::className(),
    'controllerMap' => [
        'registration' => [
            'class' => \aminbbb92\user\controllers\RegistrationController::className(),
            'on ' . \aminbbb92\user\controllers\RegistrationController::EVENT_AFTER_REGISTER => function ($e) {
...
```php
\yii\base\Event::on(
    \aminbbb92\user\controllers\RegistrationController::className(),
    \aminbbb92\user\controllers\RegistrationController::EVENT_AFTER_CONFIRM,
    function () {        
